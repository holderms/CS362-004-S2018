  ...
  int initializeGame(int numPlayers, int kingdomCards[10], int randomSeed,
    ...
    int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
    {
      ...
      switch( card )
      {
        ...
        case village:
        return villagefun(handPos, currentPlayer, state);
        ...
        case great_hall:
        return great_hallfun(currentPlayer, state, handPos);
        ...
        case steward:
        return stewardfun(choice1, choice2, choice3, handPos, currentPlayer, state);
